...
class SurfaceBasedVolumeSolver:
    def __init__(self, memory: Memory, nParticles, nTris, retStf=1e-6):
        self.mem  = memory
        self.size = nTris
        self.retStf = retStf
    ...
    def updateVol(self):
        ...
        for i in self.nSum:
            ...
            #print(i, mem.newPos[i], mem.newPos[i].transpose() @ self.nSum[i])
        self.V[None] /= 3.
        print(self.V[None])
